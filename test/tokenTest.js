...
contract('StandardToken', function ([ contractOwner, owner, recipient, anotherAccount]) {
  ...
  const seedBalance = new web3.BigNumber("1000000000000000000000000000")
  ...
  describe('total supply', function () {
    it('returns the total amount of tokens', async function () {
      ...
      assert.equal(totalSupply.toString(), seedBalance.toString());
    });
  });
  ...
  describe('balanceOf', function () {
    ...
    describe('when the requested account has some tokens', function () {
      it('returns the total amount of tokens', async function () {
        ...
        assert.equal(balance.toString(), seedBalance.toString());
      });
    });
  });
  ...
  describe('transfer', function () {
    describe('when the recipient is not the zero address', function () {
      ...
      describe('when the sender does not have enough balance', function () {
        const amount = seedBalance.add(1);
      ...
      describe('when the sender has enough balance', function () {
        ...
        it('transfers the requested amount', async function () {
          ...
          assert.equal(recipientBalance, amount.toString());
        });
  ...
  describe('transfer from', function () {
    ...
    describe('when the recipient is not the zero address', function () {
      ...
      describe('when the spender has enough approved balance', function () {
        beforeEach(async function () {
          await this.token.approve(spender, seedBalance, { from: owner });
        });
  ...
  describe('Initial balance on trezor account', function () {
